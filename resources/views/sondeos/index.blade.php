...
<div id="Background"  class=" container-lg container-sm  ">
    ...
    <form class="w-auto form-control w-50 rounded-3 border-dark shadow" method="post" action=" {{ route('registrarSondeo') }} " enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" action="#">
                        <select required class="form-select my-2" name="preguntas_idpreguntas" id="" disabled>
                ...
                <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-success">Guardar opcion</button>
                </div>
            </div>
            </div>
        </div>
        ...
        <input name="fecha_nac" placeholder="AAAA-MM-DD" class="form-control" type="textarea">
        ...
        <button type="button" class="btn btn-success" name="certificado_idcertificado">Generar certificado</button>
    </form>
</div>
</div>
</section>
